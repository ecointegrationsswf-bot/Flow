...
public class MonitorController(IMediator mediator, ITenantContext tenantCtx, AgentFlowDbContext db) : ControllerBase
{
    ...
    {
        // Filtro simple por fecha civil: DATE(LastActivityAt) BETWEEN DATE(from) AND DATE(to).
        // No se toma en cuenta hora ni timezone — si el usuario selecciona "05/05",
        // queremos cualquier conversación cuya fecha sea 05/05, sin considerar huso.
