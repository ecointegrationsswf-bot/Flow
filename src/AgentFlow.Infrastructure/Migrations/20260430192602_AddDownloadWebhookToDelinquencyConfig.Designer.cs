...
namespace AgentFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260430192602_AddDownloadWebhookToDelinquencyConfig")]
    partial class AddDownloadWebhookToDelinquencyConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.ActionFieldMapping", b =>
                {
                    ...
                    b.Property<string>("LogicalFieldKey")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("ActionDefinitionId", "LogicalFieldKey")
                        .IsUnique();
