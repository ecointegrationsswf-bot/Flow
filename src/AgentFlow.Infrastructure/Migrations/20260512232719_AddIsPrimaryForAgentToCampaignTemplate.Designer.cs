...
namespace AgentFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260512232719_AddIsPrimaryForAgentToCampaignTemplate")]
    partial class AddIsPrimaryForAgentToCampaignTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.CampaignContact", b =>
                {
                    ...
                    b.Property<string>("FollowUpsSentJson")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasDefaultValueSql("'[]'");
                    ...
                    b.HasIndex("DispatchStatus", "ScheduledFor");
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.CampaignTemplate", b =>
                {
                    ...
                    b.Property<string>("AutoCloseMessage")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<string>("FollowUpMessagesJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsPrimaryForAgent")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("TenantId", "AgentDefinitionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.ScheduledWebhookJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ScheduledWebhookJobs", (string)null);
                });

            modelBuilder.Entity("AgentFlow.Domain.Entities.ScheduledWebhookJobExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ScheduledWebhookJobExecutions", (string)null);
                });

            modelBuilder.Entity("AgentFlow.Domain.Entities.ScheduledWebhookJobExecutionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ScheduledWebhookJobExecutionItems", (string)null);
                });
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("AssignedActionIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AssignedPromptIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("CampaignDispatchEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<int>("CampaignMaxPerDay")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1000);

                    b.Property<int>("CampaignMaxPerHour")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(200);
                    ...
                    b.Property<int>("CampaignMessagesPerMinute")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(6);
                    ...
                    b.Property<int>("MessageBufferSeconds")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ReferenceDocumentsEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.ScheduledWebhookJobExecution", b =>
                {
                    b.HasOne("AgentFlow.Domain.Entities.ScheduledWebhookJob", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AgentFlow.Domain.Entities.ScheduledWebhookJobExecutionItem", b =>
                {
                    b.HasOne("AgentFlow.Domain.Entities.ScheduledWebhookJobExecution", "Execution")
                        .WithMany()
                        .HasForeignKey("ExecutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
